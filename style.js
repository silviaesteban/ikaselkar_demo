	...
	ikaselkar_demoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Tabla', element: 'table', type: 'bck-stack-class', attributes: { 'class': 'bck-table-2'} },
				{ name: 'Tabla', element: 'table', type: 'bck-stack-class', attributes: { 'class': 'bck-table-3'} },
				...
				{ name: 'Celda 5', element: 'td', attributes: { 'class': 'bck-td bck-td-5'} },
				{ name: 'Celda 6', element: 'td', attributes: { 'class': 'bck-td bck-td-6'} },
				{ name: 'Celda 7', element: 'td', attributes: { 'class': 'bck-td bck-td-7'} },
