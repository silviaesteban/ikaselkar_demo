	...
	ikaselkar_demoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Ikerketa-kaxa 2', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-box-20' } },
				{ name: 'Ikerketa-kaxa 3', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-box-21' } },
